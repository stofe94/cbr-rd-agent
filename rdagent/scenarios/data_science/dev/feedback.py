...
class DSExperiment2Feedback(Experiment2Feedback):
    ...
    def generate_feedback(self, exp: DSExperiment, trace: DSTrace) -> ExperimentFeedback:
        ...
        hypothesis_feedback = HypothesisFeedback(
            ...
            # Optional key: many evaluator prompts intentionally omit this field.
            new_hypothesis=(
                resp_dict.get("New Hypothesis")
                or resp_dict.get("Next Hypothesis")
                or "No new hypothesis provided"
            ),
